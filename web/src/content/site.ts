      ...
      shots: [
        {
          ...
          sub: 'One line in its own CLI — 然后它自己同步、思考，来敲你的眼睛。',
          prompt: '/ramble 我们需要优化一下 web 页面 · make it cinematic, nonlinear',
          logs: [
            '* Sprouting… (6s · thinking)',
            '✓ workspace synced — 3 sections below hero scanned',
            '✓ proposal drafted: 电影感非线性滚动',
        ...
        },
        {
          ...
          sub: 'Voice, shots, files — 不用整理措辞，直接进同一份草稿。',
          session: 'DeepSeek Harness · dsh-session-dc2…',
          requestTitle: 'Needs your eyes:',
          requestBody: 'Refresh the homepage and scroll below the hero — 镜头节奏不对。',
          ...
          sendLabel: 'Submit feedback · 提交反馈',
      ...
      shots: [
        {
          ...
          tag: 'ASK',
          title: '你直接说需求。',
          sub: '就在 agent 自己的命令行里 — then it syncs, thinks, and knocks.',
          prompt: '/ramble 我们需要优化一下 web 页面 · make it cinematic, nonlinear',
          logs: [
            '* Sprouting… (6s · thinking)',
          ...
          tool: 'request ramble feedback',
          toolOut: '正在拉起 RambleDesk…',
        },
        {
          id: 'ramble',
          tag: 'RAMBLE',
          title: '你自由发挥，它全收下。',
          sub: '语音、截图、文件 — straight into the same draft.',
          session: 'DeepSeek Harness · dsh-session-dc2…',
          requestTitle: '需要体验：',
          requestBody: '刷新主页，滚过 Hero 看第二幕 — the loop pacing is off.',
          draftTitle: '反馈正文',
          voiceTitle: 'Ramble',
          voiceState: '正在记录',
          pauseLabel: '暂停记录',
