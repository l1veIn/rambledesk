...
pub use workspace::{
    ...
    FeedbackPackagePublisher, FeedbackPackageReader, FeedbackPackageView, FeedbackRequestQuery,
    FeedbackRequestSummary, FeedbackWorkspaceView, HostSessionInput, HostSessionQuery,
    HostSessionSummary, ListFeedbackRequestsInput, ListFeedbackRequestsOutput,
    ListHostSessionsInput, MAX_ATTACHMENT_BYTES, MAX_ATTACHMENT_COUNT,
    MAX_REQUEST_ATTACHMENT_TOTAL_BYTES, NewAttachment, PublishedFeedbackPackage,
