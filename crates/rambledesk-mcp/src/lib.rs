...
Keep what_happened within 200 characters — it is the summary the human scans — and move the full explanation, evidence, or detail into a Markdown attachment, because longer text is rejected. \
