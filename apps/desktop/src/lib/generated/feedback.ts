...
export type ListManagedSessionActivityInput = { session_id: string, before_sequence: number, limit: number | null, };
export type ManagedSessionActivityPage = { activities: Array<SessionActivity>, has_more: boolean, };
export type AgentPromptCapabilities = { image: boolean, audio: boolean, embedded_context: boolean,
/**
...
export type AgentVerificationStatus = "verified" | "unsupported" | "unverified";
export type AgentVerification = { status: AgentVerificationStatus, versions: Array<string>, note: string, };
export type AgentDependency = { command: string, required: boolean, package: string | null, pinned_version: string | null, instructions: string, };
export type AgentCatalogEntry = { id: string, name: string, host_id: string, description: string, connection_kind: AgentConnectionKind, distribution: AgentDistribution, args: Array<string>, dependencies: Array<AgentDependency>, verification: AgentVerification, };
export type AgentInstallSource = "managed" | "system" | "missing";
...
export type AgentSessionCapabilities = { load_session: boolean, resume_session: boolean, http_mcp: boolean, prompt: AgentPromptCapabilities, };
