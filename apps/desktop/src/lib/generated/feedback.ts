...
export type ManagedSessionSnapshot = { session: SessionRecord, runtime: SessionRuntime, };
...
export type ApplicationResourceKey = { "kind": "all" } | { "kind": "navigation" } | { "kind": "host_session_resources", host_id: string, host_session_id: string, } | { "kind": "feedback_workspace", request_id: string, } | { "kind": "published_feedback", request_id: string, };
