...
export type SessionPermission = { request_id: string, session_id: string, title: string, options: Array<SessionPermissionOption>, };
...
export type SessionActivity = { id: string, session_id: string, sequence: number, turn_id: string | null, kind: SessionActivityKind, text: string, tool_call_id: string | null, created_at: string, };
