...
export type ManagedSessionSnapshot = { session: SessionRecord, runtime: SessionRuntime, activities: Array<SessionActivity>, permissions: Array<SessionPermission>, deliveries: Array<FeedbackDelivery>, };
