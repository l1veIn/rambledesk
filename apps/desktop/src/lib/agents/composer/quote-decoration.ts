...
// RambleDesk: local imports, framework-free extensions, and scoped CSS names.
import { Extension } from "@tiptap/core"
import type { Node as ProseMirrorNode } from "@tiptap/pm/model"
import { Plugin, PluginKey } from "@tiptap/pm/state"
import { Decoration, DecorationSet } from "@tiptap/pm/view"

import { quoteMarkerLength } from "./message-quote"

/** CSS class painted over one `> ` marker (see globals.css). */
export const QUOTE_MARKER_CLASS = "ramble-composer-quote-marker"
